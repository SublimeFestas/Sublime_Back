...
from core.views import UserViewSet, EnderecoViewSet, AluguelViewSet, TokenViewSet, ServicoViewset, FeedbackViewSet, AllValuesViewSet
...
router.register(r'allcounts', AllValuesViewSet, basename='allcounts')
